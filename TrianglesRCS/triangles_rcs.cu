...
static __forceinline__ __device__ void trace2(
    ...
    float tmin, float tmax, Payload* prd, int offset, int stride, int miss) {
    unsigned int p0, p1;
...
extern "C" __global__ void __raygen__rg() {
    ...
    trace2(params.handle, ray_origin, ray_direction, tmin, tmax, pldptr, 0, 1,
           0);
}
...
extern "C" __global__ void __closesthit__triangle() {
    ...
    trace2(params.handle, hit_point, reflect_dir, tmin, tmax, pldptr, 0, 1, 0);
}
